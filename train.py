...
class Trainer():
    ...
    def __init__(self, data_directory, batch_size, latent_size=100, device='cpu', lr=0.0002, num_workers=1):
        ...
        self.dataset = torchvision.datasets.CelebA(data_directory, split='all', transform=transformation, download=True)
    ...
    def train(self, epochs, saved_image_directory, saved_model_directory):
        ...
        for epoch in range(epochs):
            ...
            #show samples
            z = torch.randn(100, self.latent_size).to(self.device)
